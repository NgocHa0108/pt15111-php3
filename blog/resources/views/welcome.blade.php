...
class StudentController extends Controller
{
    ...
    {
        return view('layout.Edit_student', ['student' => $student]);
    }
    ...
    {
        //gan gia tri moi cho cac thuoc tinh
...
//cach 2: $student->update(['name' => $request->name]);
    ...
    {
       if ($student) {
           $student->delete();// tra ve kq laf true hoac false
       }
       //cach 2: Student::destroy($student->id); // tra ve so luong ban ghi
